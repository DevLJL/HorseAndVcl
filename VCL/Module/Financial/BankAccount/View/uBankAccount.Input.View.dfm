inherited BankAccountInputView: TBankAccountInputView
  ClientHeight = 600
  ClientWidth = 600
  OnShow = FormShow
  ExplicitWidth = 600
  ...
  object dtsBankAccount: TDataSource [2]
    Left = 851
    Top = 1
  end
end
