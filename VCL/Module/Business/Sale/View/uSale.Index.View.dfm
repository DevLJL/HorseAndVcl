inherited SaleIndexView: TSaleIndexView
            ...
            inherited DBGrid1: TDBGrid
              ...
              Columns = <
                ...
                item
                  ...
                  Title.Caption = 'Cliente (Raz'#227'o/Nome)'
                  Width = 250
                  Visible = True
                end
                item
                ...
                item
                  Expanded = False
                  FieldName = 'person_alias_name'
                  Title.Caption = 'Cliente (Fantasia/Apelido)'
                  Width = 250
                  Visible = True
                end>
            end
    ...
    inherited SplitView1: TSplitView
      inherited pnlSplitView: TPanel
        ...
        inherited scbSplitView: TScrollBox
          ...
          object chkFilterGeneralResearchMethodAnyPart: TCheckBox
            Left = 160
            Top = 11
            Width = 149
            Height = 17
            Cursor = crHandPoint
            Caption = 'Pesquise em qualquer parte'
            TabOrder = 1
            OnClick = imgDoSearchClick
          end
        end
  ...
  object ppmOptions: TPopupMenu
    ...
    object mniSpacePrint: TMenuItem
      Caption = '-'
    end
    ...
    object mniPrintA4: TMenuItem
      Caption = '    PDF'
      OnClick = mniPrintA4Click
    end
    object mniSendA4ByEmail: TMenuItem
      Caption = '    Enviar p/ E-mail'
      OnClick = mniSendA4ByEmailClick
    end
    ...
    object mniOperation: TMenuItem
      Caption = '* Opera'#231#245'es *'
      Enabled = False
    end
    object mniGenerateOrUndoSale: TMenuItem
      Caption = '    Faturar/Estornar Venda'
      OnClick = mniGenerateOrUndoSaleClick
    end
    object mniCancelSale: TMenuItem
      Caption = '    Cancelar Venda'
      OnClick = mniCancelSaleClick
    end
    object N3: TMenuItem
      Caption = '-'
    end
