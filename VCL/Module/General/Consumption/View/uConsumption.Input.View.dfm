inherited ConsumptionInputView: TConsumptionInputView
  ClientHeight = 600
  ClientWidth = 600
  OnShow = FormShow
  ExplicitWidth = 600
      ...
      inherited pgc: TPageControl
        ...
        inherited tabMain: TTabSheet
          ...
          inherited pnlMain: TPanel
            ...
            object chkflg_active: TDBCheckBox
              Left = 168
              Top = 101
              Width = 71
              Height = 17
              Caption = 'Ativo'
              DataField = 'flg_active'
              DataSource = dtsConsumption
              TabOrder = 3
              ValueChecked = '1'
              ValueUnchecked = '0'
  ...
  object dtsConsumption: TDataSource [2]
    Left = 851
    Top = 1
  end
end
