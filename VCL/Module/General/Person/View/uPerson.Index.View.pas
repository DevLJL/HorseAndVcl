...
begin
  ...
  Try
    ...
    const LStored: SH<TPersonShowDTO> = TPersonInputView.Handle(TEntityState.Store);
...
begin
  ...
  // Visualizar Registro
  TPersonInputView.Handle(TEntityState.View, dtsIndex.DataSet.Fields[0].AsLargeInt);
end;
