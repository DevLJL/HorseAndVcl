inherited AdditionalInputView: TAdditionalInputView
  ClientHeight = 600
  ClientWidth = 600
        ...
        inherited tabMain: TTabSheet
          ...
          inherited pnlMain: TPanel
            ...
            object DBRadioGroup2: TDBRadioGroup
              ...
              DataField = 'price_calculation_type'
              DataSource = dtsAdditional
              Items.Strings = (
                'Soma dos Pre'#231'os'
                'Maior Pre'#231'o')
            ...
            object Panel2: TPanel
              ...
              ParentBackground = False
              TabOrder = 6
              object dbgAdditionalProducts: TDBGrid
                Left = 1
                Top = 1
                Width = 548
                Height = 225
                ...
                BorderStyle = bsNone
                Color = clWhite
                DataSource = dtsAdditionalProducts
                ...
                OnCellClick = dbgAdditionalProductsCellClick
                OnDrawColumnCell = dbgAdditionalProductsDrawColumnCell
                Columns = <
                  item
                    Alignment = taCenter
                    Expanded = False
  ...
  object dtsAdditional: TDataSource [2]
    Left = 379
    Top = 1
  end
  ...
  object dtsAdditionalProducts: TDataSource
    Left = 483
    Top = 1
  end
end
