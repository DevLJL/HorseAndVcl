...
uses
  ...
  Vcl.StdCtrls, Vcl.WinXCtrls, Vcl.ExtCtrls, Vcl.Buttons, Vcl.Grids, Vcl.DBGrids,
  Vcl.Imaging.pngimage, Skia, Skia.Vcl, Vcl.NumberBox, uBase.DTO, uAppVcl.Types;
...
type
  TBaseIndexView = class(TForm)
    ...
    edtNavLimitPerPage: TNumberBox;
    Panel1: TPanel;
    Panel2: TPanel;
    Label1: TLabel;
    edtNavLastPageNumber: TNumberBox;
    ...
    procedure pnlContentMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure DBGrid1DrawColumnCell(Sender: TObject; const Rect: TRect; DataCol: Integer; Column: TColumn; State: TGridDrawState); virtual;
  private
...
procedure TBaseIndexView.DBGrid1DrawColumnCell(Sender: TObject; const Rect: TRect; DataCol: Integer; Column: TColumn; State: TGridDrawState);
begin
