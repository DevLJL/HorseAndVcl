...
begin
  // Obter FilterDTO
  const LFilter: SH<TStationFilterDTO> = TStationFilterDTO.FromReq(FReq);
...
begin
  ...
  // Inserir
  const LUseCaseResult: Either<String, TStationShowDTO> = FPersistence.StoreAndShow(LInput);
