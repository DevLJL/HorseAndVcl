...
type
  TPosPrinterShowDTO = class(TPosPrinterInputDTO)
  private
  ...
  // SwaggerDoc
  // ---------------------------------------------------------------------------
  TPosPrinterShowResponseDTO = class(TResponseDTO)
  private
    Fdata: TPosPrinterShowDTO;
  public
    property data: TPosPrinterShowDTO read Fdata write Fdata;
  end;

  TPosPrinterIndexDataResponseDTO = class
  private
    Fmeta: TResponseMetaDTO;
    Fresult: TObjectList<TPosPrinterShowDTO>;
  public
    property result: TObjectList<TPosPrinterShowDTO> read Fresult write Fresult;
    property meta: TResponseMetaDTO read Fmeta write Fmeta;
  end;

  TPosPrinterIndexResponseDTO = class(TResponseDTO)
  private
    Fdata: TPosPrinterIndexDataResponseDTO;
  public
    property data: TPosPrinterIndexDataResponseDTO read Fdata write Fdata;
  end;
  // ---------------------------------------------------------------------------
  {$ENDIF}
