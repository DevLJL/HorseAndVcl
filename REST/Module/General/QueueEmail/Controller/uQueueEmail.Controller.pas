...
begin
  // Obter FilterDTO
  const LFilter: SH<TQueueEmailFilterDTO> = TQueueEmailFilterDTO.FromReq(FReq);
...
begin
  ...
  // Inserir
  const LUseCaseResult: Either<String, TQueueEmailShowDTO> = FPersistence.StoreAndShow(LInput);
