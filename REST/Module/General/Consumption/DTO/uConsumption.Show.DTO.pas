...
type
  TConsumptionShowDTO = class(TConsumptionInputDTO)
  private
  ...
  // SwaggerDoc
  // ---------------------------------------------------------------------------
  TConsumptionShowResponseDTO = class(TResponseDTO)
  private
    Fdata: TConsumptionShowDTO;
  public
    property data: TConsumptionShowDTO read Fdata write Fdata;
  end;

  TConsumptionIndexDataResponseDTO = class
  private
    Fmeta: TResponseMetaDTO;
    Fresult: TObjectList<TConsumptionShowDTO>;
  public
    property result: TObjectList<TConsumptionShowDTO> read Fresult write Fresult;
    property meta: TResponseMetaDTO read Fmeta write Fmeta;
  end;

  TConsumptionIndexResponseDTO = class(TResponseDTO)
  private
    Fdata: TConsumptionIndexDataResponseDTO;
  public
    property data: TConsumptionIndexDataResponseDTO read Fdata write Fdata;
  end;
  // ---------------------------------------------------------------------------
  {$ENDIF}
