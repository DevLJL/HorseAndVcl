...
type
  TConsumption = class(TBaseEntity)
  private
    Fid: Int64;
    Fnumber: SmallInt;
...
procedure TConsumption.Initialize;
begin
  Fcreated_at          := now;
...
function TConsumption.Validate: String;
var
...
begin
  ...
  if (Fnumber <= 0) then
    Result := Result + Trans.FieldWasNotInformed('Número do Consumo') + #13;
end;
