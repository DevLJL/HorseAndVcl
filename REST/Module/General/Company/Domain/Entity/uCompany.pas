...
procedure TCompany.BeforeSave(AState: TEntityState);
begin
  TCompanyBeforeSave.Make(Self, AState).Execute;
end;
...
procedure TCompany.Initialize;
begin
  Fcity := TCity.Create;
end;

function TCompany.Validate: String;
var
...
function TCompany.BeforeSaveAndValidate(AState: TEntityState): String;
begin
  BeforeSave(AState);
  Result := Validate;
end;
