...
begin
  // Obter FilterDTO
  const LFilter: SH<TChartOfAccountFilterDTO> = TChartOfAccountFilterDTO.FromReq(FReq);
...
begin
  ...
  // Inserir
  const LUseCaseResult: Either<String, TChartOfAccountShowDTO> = FPersistence.StoreAndShow(LInput);
