...
begin
  // Obter FilterDTO
  const LFilter: SH<TCashFlowFilterDTO> = TCashFlowFilterDTO.FromReq(FReq);
...
begin
  ...
  // Inserir
  const LUseCaseResult: Either<String, TCashFlowShowDTO> = FPersistence.StoreAndShow(LInput);
