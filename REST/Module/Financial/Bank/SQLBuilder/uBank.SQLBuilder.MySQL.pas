...
begin
  const lStrList: SH<TStringList> = TStringList.Create;
  lStrList.Value.Add('INSERT INTO `bank` (`name`,`code`) VALUES (''000 - CAIXA FUNDO FIXO'',''001'');');
  ...
  lStrList.Value.Add('INSERT INTO `bank` (`name`,`code`) VALUES (''399 - HSBC BANK BRASIL S.A. � BANCO M�LTIPLO'',''399'');');
  ...
  lStrList.Value.Add('INSERT INTO `bank` (`name`,`code`) VALUES (''652 - ITA� UNIBANCO HOLDING S.A.'',''652'');');
  ...
  lStrList.Value.Add('INSERT INTO `bank` (`name`,`code`) VALUES (''007 - BANCO NAC DESENV_REST. ECO. SOCIAL S.A'',''7'');');
